  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Privacy & Data Controls Stub</Text>
        <Text style={styles.description}>
          Manage your personal information, profile visibility, audio recordings storage permissions, and exported transcripts.
        </Text>
