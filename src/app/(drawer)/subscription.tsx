  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Upgrade to Pro Stub</Text>
        <Text style={styles.description}>
          Get unlimited practice conversations, instant pronunciation feedback, custom vocabulary lists, and deep analytical reports.
        </Text>
